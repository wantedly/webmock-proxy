...
import (
	...
	dbpkg "github.com/wantedly/webmock-proxy/example/go/api/db"
	"github.com/wantedly/webmock-proxy/example/go/api/helper"
	"github.com/wantedly/webmock-proxy/example/go/api/models"
	"github.com/wantedly/webmock-proxy/example/go/api/version"
